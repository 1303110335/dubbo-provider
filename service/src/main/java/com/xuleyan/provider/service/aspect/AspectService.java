 ...
 */
package com.xuleyan.provider.service.aspect;
...
//    @Before(value="execution(* com.xuleyan.provider.service.facade.impl.*.*(..))")
...
//    @After(value="execution(* com.xuleyan.provider.service.facade.impl.*.*(..))")
//    public void after(JoinPoint joinPoint){
//        Object[] args = joinPoint.getArgs();
//        String name = joinPoint.getSignature().getName();
//        System.out.println("方法后****切面方法**"+name+"***"+ Arrays.toString(args));
//    }
//    @AfterReturning(value="execution(* com.xuleyan.provider.service.facade.impl.*.*(..))" ,returning = "result")
//    public void afterRunning(JoinPoint joinPoint,Object result){
//        Object[] args = joinPoint.getArgs();
//        String name = joinPoint.getSignature().getName();
//        System.out.println("方法返回后****切面方法**"+name+"***"+ Arrays.toString(args)+"***"+result);
//    }
    @Around(value="execution(* com.xuleyan.provider.service.facade.impl.*.*(..))")
    ...
    @AfterThrowing(value = "execution (* com.xuleyan.provider.service.facade.impl.*.*(..))", throwing = "e")
